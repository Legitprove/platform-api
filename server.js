...
const pool = new Pool({
  user: "postgres",
  host: "legitprovedb.cdaycamwwerh.ap-south-1.rds.amazonaws.com",
  database: "legitproveDB", // use the correct database
  password: "Wifikun412$",
  port: 5432,
  ssl: {
...
const userPool = new Pool({
  host: "legitprove-db.cdaycamwwerh.ap-south-1.rds.amazonaws.com",
  user: "register",
  port: 5432,
  password: "Wifikun412$",
  database: "postgres",
...
AWS.config.update({
  accessKeyId: "AKIAYNZQXX6CK3QHJEVE", // Your AWS Access Key
  secretAccessKey: "8nYKkv8GCk9WlUV603ee0Hh2r+NT6GwrkfTVMHdJ", // Your AWS Secret Access Key
